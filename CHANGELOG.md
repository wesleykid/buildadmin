...
- 增加左分双栏布局方式
- 增加布局的漫游式新手引导
- 上传组件支持拖拽上传、截图上传、粘贴上传 !205
- 新增多个布局配置，优化布局配置
- 升级前端依赖
- 提高 node 及包管理器的最低版本要求
- 最低 PHP 版本提高至 8.2
- 布局配置增加侧边菜单悬停时背景色自定义的功能
- 安装程序增加 64 位 PHP 的检查

### 重构/优化/修复
- 修复 columnDisplay 默认勾选状态错误的问题 !204
- 修复常驻内存下部分方法会重复发送 Content-Length 头的问题
- 去除全局的 outline: none 样式
- 优化远程下拉无数据时 el-popover 宽度可能溢出的问题 !198
- 去除 TS 配置中的 baseUrl
- 优化 el-radio 和 el-checkbox 在小屏设备下的样式细节
- 不再使用 CSS 限定菜单项 hover 时的背景颜色
- 优化模块安装逻辑、修复模块可能无法从纯净安装切换为完整安装的问题
- 修复 php8.5 中 imagedestroy 函数已经废弃的问题
- 升级 thinkphp 到 8.1.4 以兼容 php8.5
